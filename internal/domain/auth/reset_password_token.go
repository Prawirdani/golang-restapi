...
var (
	...
	ErrResetPasswordTokenInvalid = domain.ErrForbidden(
	...
	ErrResetPasswordTokenNotFound = domain.ErrNotFound("Reset password token not found")
)
...
func (t *ResetPasswordToken) Revoke() {
	t.UsedAt = nullable.New(time.Now(), false)
}
