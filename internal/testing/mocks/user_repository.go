...
func (_mock *UserRepository) GetByID(ctx context.Context, userID string) (*user.User, error) {
...
func (_c *UserRepository_GetByID_Call) Run(run func(ctx context.Context, userID string)) *UserRepository_GetByID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *UserRepository_GetByID_Call) RunAndReturn(run func(ctx context.Context, userID string) (*user.User, error)) *UserRepository_GetByID_Call {
	_c.Call.Return(run)
	return _c
}
